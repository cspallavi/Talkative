...
import static com.example.pallavi.chat_app.R.id.about;
import static com.example.pallavi.chat_app.R.id.block;
...
int c;
 ...
 private List<Get_set_pchat> pchatList = new ArrayList<>();
    ...
    private PchatAdapter mAdapter;String message1;
EditText get_message1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new PchatAdapter(pchatList,PrivateChats.this);
       ...
       // recyclerView.addItemDecoration(new DividerItemDecoration(this, LinearLayoutManager.VERTICAL));
        recyclerView.setLayoutManager(new LinearLayoutManager(PrivateChats.this,VERTICAL,true));
// set the adapter
        ...
        send1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((wait == 0)&&((message1!=null)&&(message1!=" ") )){
                                ...
                                public void onResponse(Call call, final Response response) throws IOException {
                                    ...
                                    try {
                                        ...
                                        PrivateChats.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(PrivateChats.this, "message inserted", Toast.LENGTH_LONG).show();
                                                recyclerView.setLayoutManager(new LinearLayoutManager(PrivateChats.this,VERTICAL,true));
                                                //preparePchatData();
                                            }
                                        });
                    ...
                    Toast.makeText(PrivateChats.this,"enter some text before clicking send",Toast.LENGTH_LONG).show();
                }
            }
        });
